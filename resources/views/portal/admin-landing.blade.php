...
<body class="flex min-h-screen min-h-[100dvh] flex-col bg-slate-50 font-sans text-base text-brand-dark antialiased">
    ...
    <main id="staff-main" tabindex="-1" class="relative isolate z-0 flex flex-1 flex-col overflow-x-hidden outline-none">
        ...
        <section class="relative z-[1] mx-auto flex w-full max-w-6xl flex-1 flex-col justify-center px-4 pb-12 pt-36 sm:px-6 sm:pb-14 sm:pt-32 lg:px-8">
            {{-- Brand row --}}
            <div class="mb-6 flex shrink-0 -translate-y-2 flex-wrap items-center justify-center gap-5 sm:mb-7 sm:gap-8 md:mb-10 md:gap-12 lg:gap-16">
                <img src="{{ asset('Love Impasugong.png') }}" alt="" class="h-24 w-auto max-h-[184px] max-w-[min(48vw,240px)] object-contain sm:h-36 sm:max-w-[270px] md:h-44 md:max-w-[310px]" loading="lazy" width="270" height="158" role="presentation">
                <img src="{{ asset('SYSTEMLOGO.png') }}" alt="" class="h-24 w-auto max-h-[184px] max-w-[min(48vw,240px)] object-contain sm:h-36 sm:max-w-[270px] md:h-44 md:max-w-[310px]" loading="lazy" width="270" height="270" role="presentation">
                <img src="{{ asset('Lgu Socmed Template-02 2.png') }}" alt="" class="h-20 w-auto max-h-[168px] max-w-[min(94vw,420px)] object-contain sm:h-36 sm:max-w-[460px] md:h-40 md:max-w-[min(520px,54vw)] lg:h-44" loading="lazy" width="460" height="142" role="presentation">
            </div>
            ...
            <header class="mx-auto w-full max-w-3xl shrink-0 text-center">
                ...
                <h1 class="admin-landing-title mx-auto mt-4 w-full max-w-3xl break-words px-1 text-2xl font-extrabold leading-[1.2] tracking-tight text-brand-dark [text-shadow:_0_1px_0_rgb(255_255_255_/_0.92),_0_2px_24px_rgb(255_255_255_/_0.55)] sm:mt-5 sm:text-[2rem] md:text-[2.35rem]">
                    LGU Impasug-ong Tourism Management Console
                </h1>
                <p class="admin-landing-copy mx-auto mt-5 w-full max-w-2xl px-1 text-base font-medium leading-[1.65] text-slate-800 [text-shadow:_0_1px_0_rgb(255_255_255_/_0.9),_0_0_20px_rgb(255_255_255_/_0.55)] sm:mt-6 sm:text-[1.075rem]">
