...
<body class="pdf-orientation-{{ $pdfOrientation }}">
    ...
    <main class="report-canvas">
        <table class="letterhead">
            <tr>
                <td class="letterhead-logos">
                    @if($logos['bagong'])
                        <img src="{{ $logos['bagong'] }}" class="letterhead-logo" alt="">
                    @endif
                    @if($logos['seal'])
                        <img src="{{ $logos['seal'] }}" class="letterhead-logo" alt="">
                    @endif
                    @if($logos['love'])
                        <img src="{{ $logos['love'] }}" class="letterhead-logo" alt="">
                    @endif
                </td>
                <td class="letterhead-divider"></td>
